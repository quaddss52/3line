    ...
    >
      <g filter="url(#filter0_dd_21_27254)">
        <g clip-path="url(#clip0_21_27254)">
          ...
          <foreignObject x="-2" y="13" width="42.2253" height="26">
            <div
              style={{
      ...
      <defs>
        ...
        <clipPath id="bgblur_1_21_27254_clip_path" transform="translate(2 -13)">
          <path d="M3 18H35.2254V21.2C35.2254 25.6804 35.2254 27.9206 34.3534 29.6319C33.5864 31.1372 32.3626 32.3611 30.8573 33.1281C29.146 34 26.9058 34 22.4254 34H15.8C11.3196 34 9.07937 34 7.36808 33.1281C5.86278 32.3611 4.63893 31.1372 3.87195 29.6319C3 27.9206 3 25.6804 3 21.2V18Z" />
        </clipPath>
        <linearGradient
